...
exports.OpenApiWechatController = void 0;
const axios_1 = require("@nestjs/axios");
const common_1 = require("@nestjs/common");
const http_service_1 = require("../service/http.service");
let OpenApiWechatController = class OpenApiWechatController {
    httpService;
    openApiHttpService;
...
OpenApiWechatController = __decorate([
    (0, common_1.Controller)('/open/wechat'),
    __metadata("design:paramtypes", [axios_1.HttpService,
        http_service_1.OpenApiHttpService])
], OpenApiWechatController);
exports.OpenApiWechatController = OpenApiWechatController;
