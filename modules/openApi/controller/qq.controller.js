...
exports.OpenApiQQController = void 0;
...
let OpenApiQQController = class OpenApiQQController {
    httpService;
    openApiHttpService;
    ...
    async getQQAvatar(query, res) {
        ...
        if (qq) {
            ...
            return res.send(new Response_modal_1.ErrorModal(null, '获取qq失败'));
        }
    }
};
__decorate([
...
], OpenApiQQController.prototype, "getQQAvatar", null);
OpenApiQQController = __decorate([
    (0, common_1.Controller)('/open/qq'),
    __metadata("design:paramtypes", [axios_1.HttpService,
        http_service_1.OpenApiHttpService])
], OpenApiQQController);
exports.OpenApiQQController = OpenApiQQController;
//# sourceMappingURL=qq.controller.js.map